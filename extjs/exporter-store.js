...
//      Calculate cell data types and extra class names which affect formatting
	...
	var cm2 = this.getSelectedIds()
	    ;
	var formParams = this.getFormParams();
	console.log("formParams:"+formParams.selected);
	var selectedIds = this.getSelectedIds();
	    this.selModel.noPaging = true;
	    console.log("formParams_selectedIds:"+selectedIds);

	    console.log("formParams_isAllSelected:"+this.isAllSelected())
	    ;
	    console.log("formParams_selectedNames:"+this.selModel.getSelectedIds());
	    console.log("formParams_selectedNames:"+this.selModel.getSelection());
	     console.log("formParams_selectedNames_counter:"+this.selModel.getSelection().length);
	     console.log("formParams_selectedNames_counter:"+this.selModel.getSelectionMode());
	     console.log("formParams_selectedNames_counter:"+this.selModel.selected.getCount());

	    var counter = 0;
	    this.getStore().each(function(record){
		console.log("formParams_counter:"+counter);
counter=counter+1;
		...
		console.log("formParams_rawData:"+thisProxy.getReader().rawData);
		  records   = this.selModel.selected;
...
console.log("myrecord:"+myrecord.getId());
		    ...
		    console.log("records_2:"+records.getCount());
...
var classof = records.store instanceof Ext.util.MixedCollection
console.log("records:"+records.array);


/*
records.array.forEach(function (item, index) {
  console.log(item, index);
});
*/
//console.log("records:"+JSON.stringify(records));
console.log("records_store:"+records.store.getTotalCount());
console.log("records_store:"+JSON.stringify(records.store.getAt(15).data));
records.localSelections.each(function(model){
	console.log("records:"+model);
})
console.log("records_classof:"+classof);
console.log("records_class_name:"+records.constructor.name);
records.each( function(item,index,length){

	console.log("record_foreach:"+record[0]);
})
        for (var i = 0, it = records, l = records.getCount(); i < l; i++) {
            t += '<ss:Row>';
            var cellClass = (i & 1) ? 'odd' : 'even';
		console.log("records:"+it.getAt(i));
            r = it[i].data;
