...
<script type="text/javascript" src = "../scripts/ext-4.1.0/ext-all.js"></script>
<script type="text/javascript" src = "../scripts/sailpoint/grid/SelectionCollection.js"></script>
<script type="text/javascript" src = "../scripts/sailpoint/grid/CheckboxSelectionModel.js"></script>
<script type="text/javascript" src = "../scripts/sailpoint/utils/Utils.js"></script>
<script type="text/javascript" src = "../scripts/sailpoint/grid/PagingGrid.js"></script>
<script type="text/javascript" src = "../scripts/sailpoint/grid/PagingCheckboxGrid.js"></script>
<script type="text/javascript" src = "../scripts/ext-4.1.0/locale/ext-lang-he-out.js"></script>
...
for(TaskDefinition taskDefinition : taskDefinitions){
	...
	resultRow.put("created",created.getTime());
